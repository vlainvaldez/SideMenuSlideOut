...
public final class FirstCell: UICollectionViewCell {
...
extension FirstCell {
    public static var identifier: String = "FirstCell"
}

extension FirstCell: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.configure(title: "Item \(indexPath.item)")
...
extension FirstCell: UITableViewDelegate {
